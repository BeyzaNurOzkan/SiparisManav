...
namespace PRMYTASSİST.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        //    {
        //        User tmpUser = db.Users.Find(id);
        //        tmpUser.IsConfirm = true;
        //        db.SaveChanges();
        //        result = "Kullanıcı onaylandı.";
        //    }
        //    catch (Exception)
        //    {
        //        result = "Bir hata ile karşılaşıldı.";
        ...
        //    {
        //        User tmpUser = db.Users.Find(id);
        //        tmpUser.IsConfirm = false;
        //        db.SaveChanges();
        //        result = "Kullanıcı kaydı iptal edildi.";
        //    }
        //    catch (Exception)
        //    {
        //        result = "Bir hata ile karşılaşıldı.";
        ...
        //public JsonResult GetConfirmUsers()
        //{
        //    var userList = new
        //    {
        //        data = from user in db.Users
        //               where user.IsConfirm == true
        //               where user.UserRole == Role.Standart
        //               orderby user.RegisterDate, user.IsConfirm
        //               select new
        //               {
        //                   ID = user.ID,
        ...
        //                   CreatedDate = user.RegisterDate.ToString()
        //               }
        //    };
        //    return Json(userList, JsonRequestBehavior.AllowGet);
        //}
