    ...
    var initChat = function (parentEl) {
        ...
        KTUtil.scrollInit(messageListEl, {
            ...
            height: function () {  // calculate height
                ...
                if (chatEl) {
                    height = height + 100 - parseInt(KTUtil.css(chatEl, 'margin-top')) - parseInt(KTUtil.css(chatEl, 'margin-bottom'));
                    height = height + 100 - parseInt(KTUtil.css(chatEl, 'padding-top')) - parseInt(KTUtil.css(chatEl, 'padding-bottom'));
                }
